...
void test_random(void)
{
    ...
    assert_double_equal(random_range(&random, 0, 1), 0.77411840881254556645);
    assert_double_equal(random_range(&random, 1, 2), 1.48922748458651099667);
    assert_double_equal(random_range(&random, -3, 7), 1.51714985351188635931);
    assert_double_equal(random_gauss(&random, 0, 1), 1.92496688266798221533);
    assert_double_equal(random_gauss(&random, 1, 2), -1.81970181198147629153);
    assert_double_equal(random_gauss(&random, -2, 3), -0.74949711474660718479);
}
