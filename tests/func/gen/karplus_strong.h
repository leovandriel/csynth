...
void test_karplus_strong()
{
    ...
    assert_gen_equal(gen, 0.4195619192984845);
    assert_gen_equal(gen, 0.4241761877148519);
    assert_gen_equal(gen, 0.2779732095631874);
    assert_gen_equal(gen, 0.0881769071115131);
    assert_gen_equal(gen, 0.3964402421159615);
    assert_gen_equal(gen, 0.3672583421674327);
    assert_gen_equal(gen, 0.3056282766592155);
