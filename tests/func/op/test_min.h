...
void test_min()
{
    Gen *gen1 = gen_create(min(const_(1), const_(2)));
    Gen *gen2 = gen_create(min(const_(2), const_(1)));
    Gen *gen3 = gen_create(min(const_(4), const_(2), const_(3)));
    Gen *gen4 = gen_create(min(const_(1)));
