...
func beats()
{
    func base = mul_3(sine(A1), hump(0, 0.01, .05, .1), cons(2));
    func hat = mul_3(sum(saw(A5), noise()), hump(0, 0.005, 0.005, .01), cons(.5));
    ...
    func low_line = comp(12,
                         mul_3(sine(A0), hump(0, 0.05, 1.95, 2), cons(8)), cons(2),
