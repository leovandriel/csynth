...
static double limit_eval(__U size_t count, Gen **args, Eval *eval, void *context_)
{
...
{
    return func_create(NULL, limit_eval, NULL, sizeof(LimitContext), NULL, FuncFlagNone, tick, input);
}
