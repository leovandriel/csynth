...
{
    return func_create_args(NULL, seq_eval_abs, NULL, NULL, sizeof(SeqContext), NULL, FuncFlagNone, count, args, "tick, input");
}
...
{
    return func_create_args(NULL, seq_eval_rel, NULL, NULL, sizeof(SeqContext), NULL, FuncFlagNone, count, args, "tick, input");
}
...
{
    return func_create_args(NULL, seq_eval_seq, NULL, NULL, sizeof(SeqContext), NULL, FuncFlagNone, count, args, "input");
}
...
{
    return func_create_args(NULL, seq_eval_fix, NULL, NULL, sizeof(SeqContext), NULL, FuncFlagNone, count, args, "tick, input");
}
